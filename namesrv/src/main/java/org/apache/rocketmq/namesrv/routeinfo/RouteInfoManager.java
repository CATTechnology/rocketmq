...
public class RouteInfoManager {
    ...
    /**
     * 注册将Broker相关信息放入RouteInfoManager中进行管理
     *
     * @return
     */
    ...
    public void unregisterBroker(
        ...
        try {
            try {
                ...
                //将brokerId从BrokerData的brokerAddrs中移除
                BrokerData brokerData = this.brokerAddrTable.get(brokerName);
                if (null != brokerData) {
                    ...
                    //如果当前brokerAddrs不存在Broker了，就将其从brokerAddrTable中移除
    ...
    public void scanNotActiveBroker() {
        ...
        while (it.hasNext()) {
            ...
            //如果broker最后一次续约的时间加上120小于当前时间戳，则表示当前broker已经断连
